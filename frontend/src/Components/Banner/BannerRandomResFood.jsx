...
const BannerRandomRes = ({ data }) => {
    ...
    return (
        <section className='mt-[10%]'>
            {data?.map((recipe) => (
                <div key={recipe.idMeal} className="container flex flex-col-reverse gap-6 px-6 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row-reverse lg:items-center">
                        ...
                        <div className="lg:max-w-lg">
                            ...
                            <ul className="mt-8 space-y-5">
                                <li className="flex items-center -mx-2 text-gray-700">
                                    ...
                                    <p className="mx-2">{recipe.strMeal === "Fettucine alfredo" ? "American" : `${recipe.strArea}`}</p>
                                </li>
                            ...
                            <div className='mt-6'>
                                ...
                                <Link to={`/meal/${recipe.idMeal}`} className='bg-yellow-300 hover:bg-yellow-200 py-3 px-6 rounded-full text-sm font-semibold text-yellow-900'>
                                    See More
                                </Link>
                            </div>
                        </div>
...
export default BannerRandomRes